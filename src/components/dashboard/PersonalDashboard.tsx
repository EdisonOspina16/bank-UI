...
// Tarjetas view is rendered inline in the main component to wire local state handlers
...
// Virtual card view is rendered inline in the main component to wire local state handlers
